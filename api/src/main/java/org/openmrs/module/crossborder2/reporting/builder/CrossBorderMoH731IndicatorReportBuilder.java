...
@Component
@Builds({ "cross.border.moh731.indicator" })
public class CrossBorderMoH731IndicatorReportBuilder extends AbstractReportBuilder {
	
	private final CrossBorderScreeningDataset crossBorderScreeningDataset;
	
	@Autowired
	public CrossBorderMoH731IndicatorReportBuilder(CrossBorderScreeningDataset crossBorderScreeningDataset) {
